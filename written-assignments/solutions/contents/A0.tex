...
\begin{proof}
    ...
    Since $\overline{v} = 6$, according to \autoref{lemma:avg-face-edge-for-regular-valance}, $\overline{f} = 3$. Constitute them to the following equation:

    \begin{equation}
        E = \frac{\overline{v}}{2} V = \frac{\overline{f}}{2} F
        \Rightarrow \begin{cases}
            \frac{E}{V} = \frac{\overline{v}}{2} = 3\\
            \frac{F}{V} = \frac{\overline{v}}{\overline{f}} = 2\\
        \end{cases}
    \end{equation}
